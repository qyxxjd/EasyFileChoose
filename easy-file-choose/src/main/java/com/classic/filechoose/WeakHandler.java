 ...
 * <p>Original implementation of Handlers always keeps hard reference to handler in queue of
 * execution.
 ...
 * <p>This implementation is trickier, it will keep WeakReferences to runnables and messages,
 ...
 */
@SuppressWarnings({"unused", "WeakerAccess"}) class WeakHandler {
     ...
     */
    WeakHandler(@Nullable Handler.Callback callback) {
     ...
     */
    WeakHandler(@NonNull Looper looper) {
        mCallback = null;
     ...
     * @param callback The callback interface in which to handle messages, or null.
     */
    WeakHandler(@NonNull Looper looper, @NonNull Handler.Callback callback) {
        mCallback = callback;
